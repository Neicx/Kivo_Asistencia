"""
Django settings for Kivo_Asistencia project.
...
SECRET_KEY = 'django-insecure-u*lt=aif)3qg6=zq%s7$^)qgfwwie%sy&bme+#2-=2smdtq47f'
...
WSGI_APPLICATION = 'Kivo_Asistencia.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'empresa_1'),
